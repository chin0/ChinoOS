...
#define GDT_FLAGS_LOWER_DPL3        0x80
...
// 8바이트 엔트리의 개수, 널 디스크립터/커넗 코드/커널 데이터
...
typedef struct kGDTEntry8Struct
{
    ...
    // bit 4 Type, bit 1 S, bit 2 DPL, bit 1 P
    BYTE bTypeAndLowerFlag;
    // bit 4 Segment Limit, bit 1 AVL, L, D/B, G
...
typedef struct kGDTEntry16Struct
{
    ...
    // bit 4 Type, bit 1 0, bit 2 DPL, bit 1 P
    BYTE bTypeAndLowerFlag;
    // bit 4 Segment Limit, bit 1 AVL, 0, 0, G
    BYTE bUpperLimitAndUpperFlag;
